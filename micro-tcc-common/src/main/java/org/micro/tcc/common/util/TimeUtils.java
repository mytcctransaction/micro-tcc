...
/**
 * @author jeff.liu
 * @desc  借助Calendar类获取今天、昨天、本周、上周、本年及特定时间的开始时间和结束时间（返回类型为date类型）
 * @date 2019/9/4 16:32
 */
public class TimeUtils {
    ...
    public static String convertToString() throws ParseException {
        Date date=new Date();
     ...
     * @return
     */
    public static  String getDateByFormat(String sformat) {
    ...
    public static String getNo(int k) {
        return getDateByFormat("yyyyMMddhhmmss") + getRandom(k);
    }


    public static void main(String[] args) {
        try {
            System.out.println(TimeUtils.convertToString());
